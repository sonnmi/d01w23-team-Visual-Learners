...
#### **Unit tests**
Unit tests can be found in ['lib/matplotlib/tests/test_legend.py'](https://github.com/sonnmi/d01w23-team-Visual-Learners/blob/4f76ce84b030509cf5b255dea19c4a8b69ce1320/matplotlib-main/lib/matplotlib/tests/test_legend.py#L1267)
